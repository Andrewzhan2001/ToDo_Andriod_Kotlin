...
// when searchappbarstate change inside, it will be observed by ListScreen, then will recompose the listappbar
@Composable
fun ListAppBar(
...
fun SearchAppBar(
    ...
    Surface(
        ...
        TextField(
            ...
            leadingIcon = {
                IconButton(
                    // low level content alpha to represent disabled components
                ...
                IconButton(
                    onClick = {
                        when (trailingIconState) {
                            // when we first click the icon, we just delete the textfield
                            TrailingIconState.READY_TO_DELETE -> {
                                onTextChange("")
                                trailingIconState = TrailingIconState.READY_TO_CLOSE
                            }
                            // for second time we click the icon, we close the search bar
